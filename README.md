1. Remember to install MFC packages to visual studio. Goes to **visual studio installer** -> **modify**. Scroll down to **Desktop development with C++**, check the box to download (if haven't).
